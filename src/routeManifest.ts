...
async function generateRoutesFunction(customRoutes: string[]) {
  ...
  outputJS.push('/* oxlint-disable */');
  outputJS.push('/* biome-ignore-all lint: auto generated */');
  outputJS.push('/* prettier-ignore */');
  outputJS.push('/* oxfmt-ignore */');
  outputJS.push('// ################################################');
  ...
  outputDTS.push('/* eslint-disable */');
  outputDTS.push('/* oxlint-disable */');
  outputDTS.push('/* biome-ignore-all lint: auto generated */');
  outputDTS.push('/* prettier-ignore */');
  outputDTS.push('/* oxfmt-ignore */');
  outputDTS.push('// ################################################');
...
async function generateJSFile(outDir: string, routes: string[]) {
  const jsFilePath = path.join(outDir, 'index.gen.js');
  const dtsFilePath = path.join(outDir, 'index.gen.d.ts');
